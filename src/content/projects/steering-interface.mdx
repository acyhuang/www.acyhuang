...
- **Surfacing features actively influencing the LLM's outputs as "activated features":** This helps the user build a better mental model of the LLM and why it produces certain repsonses. It simultaneously prompts the user with examples of features they can adjust. 
- **Comparing responses before and after steering:** aA side-by-side comparison shows how steering directly affects outputs.
